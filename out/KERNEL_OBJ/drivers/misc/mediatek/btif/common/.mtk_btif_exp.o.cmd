cmd_drivers/misc/mediatek/btif/common/mtk_btif_exp.o := aarch64-linux-android-gcc-4.9 -Wp,-MD,drivers/misc/mediatek/btif/common/.mtk_btif_exp.o.d -nostdinc -isystem /usr/bin/../lib/gcc/aarch64-linux-android/4.9.x/include -I/buildd/sources/arch/arm64/include -Iarch/arm64/include/generated  -I/buildd/sources/include -Iinclude -I/buildd/sources/arch/arm64/include/uapi -Iarch/arm64/include/generated/uapi -I/buildd/sources/include/uapi -Iinclude/generated/uapi -include /buildd/sources/include/linux/kconfig.h   -I/buildd/sources/drivers/misc/mediatek/btif/common -Idrivers/misc/mediatek/btif/common -D__KERNEL__ -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -std=gnu89 -mgeneral-regs-only -fno-pic -fstack-usage -fno-delete-null-pointer-checks -fno-PIE -O2 --param=allow-store-data-races=0 -Werror=frame-larger-than=1 -Wframe-larger-than=1400 -fstack-protector-strong -Wno-unused-but-set-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -Werror -Werror   -I/buildd/sources/drivers/misc/mediatek/include   -I/buildd/sources/drivers/misc/mediatek/include/mt-plat/mt6797/include   -I/buildd/sources/drivers/misc/mediatek/include/mt-plat   -I/buildd/sources/drivers/mmc/host/mediatek/mt6797   -I/buildd/sources/drivers/misc/mediatek/include/mt-plat/mt6797/include   -I/buildd/sources/arch/arm/mach-mt6797/include/mach   -I/buildd/sources/drivers/misc/mediatek/include/mt-plat  -I/buildd/sources/drivers/misc/mediatek/btif/common/inc -Idrivers/misc/mediatek/btif/common/inc  -I/buildd/sources/drivers/misc/mediatek/btif/common/plat_inc -Idrivers/misc/mediatek/btif/common/plat_inc    -D"KBUILD_STR(s)=#s" -D"KBUILD_BASENAME=KBUILD_STR(mtk_btif_exp)"  -D"KBUILD_MODNAME=KBUILD_STR(btif)" -c -o drivers/misc/mediatek/btif/common/.tmp_mtk_btif_exp.o /buildd/sources/drivers/misc/mediatek/btif/common/mtk_btif_exp.c

source_drivers/misc/mediatek/btif/common/mtk_btif_exp.o := /buildd/sources/drivers/misc/mediatek/btif/common/mtk_btif_exp.c

deps_drivers/misc/mediatek/btif/common/mtk_btif_exp.o := \
  /buildd/sources/drivers/misc/mediatek/btif/common/inc/mtk_btif.h \
  ...
  /buildd/sources/drivers/misc/mediatek/btif/common/plat_inc/btif_pub.h \
    $(wildcard include/config/mtk/clkmgr.h) \
  /buildd/sources/drivers/misc/mediatek/btif/common/plat_inc/plat_common.h \
  ...
  /buildd/sources/drivers/misc/mediatek/btif/common/plat_inc/btif_dma_pub.h \

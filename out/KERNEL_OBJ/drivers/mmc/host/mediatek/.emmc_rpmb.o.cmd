cmd_drivers/mmc/host/mediatek/emmc_rpmb.o := aarch64-linux-android-gcc-4.9 -Wp,-MD,drivers/mmc/host/mediatek/.emmc_rpmb.o.d -nostdinc -isystem /usr/bin/../lib/gcc/aarch64-linux-android/4.9.x/include -I/buildd/sources/arch/arm64/include -Iarch/arm64/include/generated  -I/buildd/sources/include -Iinclude -I/buildd/sources/arch/arm64/include/uapi -Iarch/arm64/include/generated/uapi -I/buildd/sources/include/uapi -Iinclude/generated/uapi -include /buildd/sources/include/linux/kconfig.h   -I/buildd/sources/drivers/mmc/host/mediatek -Idrivers/mmc/host/mediatek -D__KERNEL__ -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -std=gnu89 -mgeneral-regs-only -fno-pic -fstack-usage -fno-delete-null-pointer-checks -fno-PIE -O2 --param=allow-store-data-races=0 -Werror=frame-larger-than=1 -Wframe-larger-than=1400 -fstack-protector-strong -Wno-unused-but-set-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -Werror   -I/buildd/sources/drivers/misc/mediatek/hibcore   -I/buildd/sources/drivers/misc/mediatek/include   -I/buildd/sources/drivers/misc/mediatek/include/mt-plat/mt6797/include   -I/buildd/sources/drivers/misc/mediatek/include/mt-plat   -I/buildd/sources/drivers/misc/mediatek/base/power/mt6797   -I/buildd/sources   -I/buildd/sources/drivers/mmc/host/mediatek/mt6797    -D"KBUILD_STR(s)=#s" -D"KBUILD_BASENAME=KBUILD_STR(emmc_rpmb)"  -D"KBUILD_MODNAME=KBUILD_STR(emmc_rpmb)" -c -o drivers/mmc/host/mediatek/.tmp_emmc_rpmb.o /buildd/sources/drivers/mmc/host/mediatek/emmc_rpmb.c

source_drivers/mmc/host/mediatek/emmc_rpmb.o := /buildd/sources/drivers/mmc/host/mediatek/emmc_rpmb.c

deps_drivers/mmc/host/mediatek/emmc_rpmb.o := \
  ...
  /buildd/sources/drivers/mmc/host/mediatek/emmc_rpmb.h \
  /buildd/sources/include/uapi/linux/mmc/ioctl.h \
...
drivers/mmc/host/mediatek/emmc_rpmb.o: $(deps_drivers/mmc/host/mediatek/emmc_rpmb.o)

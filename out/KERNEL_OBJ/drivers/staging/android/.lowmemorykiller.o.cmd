cmd_drivers/staging/android/lowmemorykiller.o := aarch64-linux-android-gcc-4.9 -Wp,-MD,drivers/staging/android/.lowmemorykiller.o.d -nostdinc -isystem /usr/bin/../lib/gcc/aarch64-linux-android/4.9.x/include -I/buildd/sources/arch/arm64/include -Iarch/arm64/include/generated  -I/buildd/sources/include -Iinclude -I/buildd/sources/arch/arm64/include/uapi -Iarch/arm64/include/generated/uapi -I/buildd/sources/include/uapi -Iinclude/generated/uapi -include /buildd/sources/include/linux/kconfig.h   -I/buildd/sources/drivers/staging/android -Idrivers/staging/android -D__KERNEL__ -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -std=gnu89 -mgeneral-regs-only -fno-pic -fstack-usage -fno-delete-null-pointer-checks -fno-PIE -O2 --param=allow-store-data-races=0 -Werror=frame-larger-than=1 -Wframe-larger-than=1400 -fstack-protector-strong -Wno-unused-but-set-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -Werror   -I/buildd/sources/drivers/misc/mediatek/include   -I/buildd/sources/drivers/misc/mediatek/include/mt-plat/mt6797/include   -I/buildd/sources/drivers/misc/mediatek/include   -I/buildd/sources/drivers/misc/mediatek/video/mt6797/   -I/buildd/sources/drivers/misc/mediatek/video/mt6797/videox/  -I/buildd/sources/drivers/staging/android -Idrivers/staging/android   -I/buildd/sources/drivers/staging/android/ion   -I/buildd/sources/drivers/misc/mediatek/include/mt-plat    -D"KBUILD_STR(s)=#s" -D"KBUILD_BASENAME=KBUILD_STR(lowmemorykiller)"  -D"KBUILD_MODNAME=KBUILD_STR(lowmemorykiller)" -c -o drivers/staging/android/.tmp_lowmemorykiller.o /buildd/sources/drivers/staging/android/lowmemorykiller.c

source_drivers/staging/android/lowmemorykiller.o := /buildd/sources/drivers/staging/android/lowmemorykiller.c
...
deps_drivers/staging/android/lowmemorykiller.o := \
  ...
  /buildd/sources/drivers/staging/android/trace/lowmemorykiller.h \
  /buildd/sources/include/linux/tracepoint.h \
    $(wildcard include/config/have/syscall/tracepoints.h) \
  /buildd/sources/include/trace/define_trace.h \
  /buildd/sources/include/trace/../../drivers/staging/android/trace/lowmemorykiller.h \

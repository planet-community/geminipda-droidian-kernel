cmd_sound/core/seq/seq_clientmgr.o := aarch64-linux-android-gcc-4.9 -Wp,-MD,sound/core/seq/.seq_clientmgr.o.d -nostdinc -isystem /usr/bin/../lib/gcc/aarch64-linux-android/4.9.x/include -I/buildd/sources/arch/arm64/include -Iarch/arm64/include/generated  -I/buildd/sources/include -Iinclude -I/buildd/sources/arch/arm64/include/uapi -Iarch/arm64/include/generated/uapi -I/buildd/sources/include/uapi -Iinclude/generated/uapi -include /buildd/sources/include/linux/kconfig.h   -I/buildd/sources/sound/core/seq -Isound/core/seq -D__KERNEL__ -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -std=gnu89 -mgeneral-regs-only -fno-pic -fstack-usage -fno-delete-null-pointer-checks -fno-PIE -O2 --param=allow-store-data-races=0 -Werror=frame-larger-than=1 -Wframe-larger-than=1400 -fstack-protector-strong -Wno-unused-but-set-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -Werror -Wno-error=maybe-uninitialized    -D"KBUILD_STR(s)=#s" -D"KBUILD_BASENAME=KBUILD_STR(seq_clientmgr)"  -D"KBUILD_MODNAME=KBUILD_STR(snd_seq)" -c -o sound/core/seq/.tmp_seq_clientmgr.o /buildd/sources/sound/core/seq/seq_clientmgr.c

source_sound/core/seq/seq_clientmgr.o := /buildd/sources/sound/core/seq/seq_clientmgr.c
...
deps_sound/core/seq/seq_clientmgr.o := \
  ...
  /buildd/sources/sound/core/seq/seq_clientmgr.h \
  /buildd/sources/sound/core/seq/seq_fifo.h \
  /buildd/sources/sound/core/seq/seq_memory.h \
  ...
  /buildd/sources/sound/core/seq/seq_lock.h \
  /buildd/sources/sound/core/seq/seq_ports.h \
  /buildd/sources/sound/core/seq/seq_queue.h \
  /buildd/sources/sound/core/seq/seq_prioq.h \
  /buildd/sources/sound/core/seq/seq_timer.h \
  /buildd/sources/include/sound/timer.h \
  ...
  /buildd/sources/sound/core/seq/seq_info.h \
  /buildd/sources/include/sound/info.h \
  /buildd/sources/sound/core/seq/seq_system.h \
  ...
  /buildd/sources/sound/core/seq/seq_compat.c \

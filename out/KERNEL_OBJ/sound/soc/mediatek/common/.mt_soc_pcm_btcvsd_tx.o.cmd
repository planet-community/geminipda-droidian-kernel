cmd_sound/soc/mediatek/common/mt_soc_pcm_btcvsd_tx.o := aarch64-linux-android-gcc-4.9 -Wp,-MD,sound/soc/mediatek/common/.mt_soc_pcm_btcvsd_tx.o.d -nostdinc -isystem /usr/bin/../lib/gcc/aarch64-linux-android/4.9.x/include -I/buildd/sources/arch/arm64/include -Iarch/arm64/include/generated  -I/buildd/sources/include -Iinclude -I/buildd/sources/arch/arm64/include/uapi -Iarch/arm64/include/generated/uapi -I/buildd/sources/include/uapi -Iinclude/generated/uapi -include /buildd/sources/include/linux/kconfig.h   -I/buildd/sources/sound/soc/mediatek/common -Isound/soc/mediatek/common -D__KERNEL__ -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -std=gnu89 -mgeneral-regs-only -fno-pic -fstack-usage -fno-delete-null-pointer-checks -fno-PIE -O2 --param=allow-store-data-races=0 -Werror=frame-larger-than=1 -Wframe-larger-than=1400 -fstack-protector-strong -Wno-unused-but-set-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -Werror -Wno-error=maybe-uninitialized -Werror   -I/buildd/sources/drivers/misc/mediatek/include -Werror   -I/buildd/sources/drivers/misc/mediatek/include/mt-plat/mt6797/include -Werror   -I/buildd/sources/drivers/misc/mediatek/include/mt-plat    -D"KBUILD_STR(s)=#s" -D"KBUILD_BASENAME=KBUILD_STR(mt_soc_pcm_btcvsd_tx)"  -D"KBUILD_MODNAME=KBUILD_STR(mt_soc_pcm_btcvsd_tx)" -c -o sound/soc/mediatek/common/.tmp_mt_soc_pcm_btcvsd_tx.o /buildd/sources/sound/soc/mediatek/common/mt_soc_pcm_btcvsd_tx.c

source_sound/soc/mediatek/common/mt_soc_pcm_btcvsd_tx.o := /buildd/sources/sound/soc/mediatek/common/mt_soc_pcm_btcvsd_tx.c

deps_sound/soc/mediatek/common/mt_soc_pcm_btcvsd_tx.o := \
  ...
  /buildd/sources/sound/soc/mediatek/common/mt_soc_pcm_btcvsd.h \
...
sound/soc/mediatek/common/mt_soc_pcm_btcvsd_tx.o: $(deps_sound/soc/mediatek/common/mt_soc_pcm_btcvsd_tx.o)
